...
{\ttfamily DATA} statement again.  In this way, a program and re-read data that
is has already read.  The {\ttfamily RESTORE} statement takes no arguments, and
...
The above code will cause the mouse cursor to display, but while the mouse is
...
sixth argument is used to set width of the sprite, and the seventh sets the
height.  Finally, the either argument sets the color mode.  Only the first two
