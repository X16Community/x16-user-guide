...
octave is C, which is represented with a {\ttfamily 1}, and the highest note of
any octave is B, which is represented with a {\ttfamily C}.  A note of
{\ttfamily 0} on any octave will release the note playing on that channel, and
the note values {\ttfamily D}, {\ttfamily E}, and {\ttfamily F} have no
effect.\\
...
\begin{tabular}{|c|c|c|c|c|c|c|c|}
	\hline
	Nybble & \$x0 & \$x1 & \$x2 & \$x3 & \$x4 & \$x5 & \$x6 \\ \hline
	Note & Release & C & C\#/Db & D & D\#/Eb & E & F \\ \hline

	Nybble & \$x7 & \$x8 & \$x9 & \$xA & \$xB & \$xC & \$xD-\$xF \\ \hline
	Note & F\#/Gb & G & G\#/Ab & A & A\#/Bb & B & no-op \\ \hline
