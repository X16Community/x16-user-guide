...
normal numeric variables.  You can access these variables by \emph{indexing}
...
By using these logical operators, you can write complex conditions for your programs:\\
