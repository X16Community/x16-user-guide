...
The {\ttfamily ABS(X)} function will return the absolute value of {\ttfamily X}.\\
...
The {\ttfamily ATN(X)} function will return the angle whose tangent is {\ttfamily X}.  This is the inverse of the {\ttfamily TAN} function.\\
...
The {\ttfamily COS(X)} function will return the cosine of an angle {\ttfamily X}, measured in radians.\\
...
The {\ttfamily SIN(X)} function will return the sine of an angle {\ttfamily X}, measured in radians.\\
