...
\begin{tabular}{l p{0.4\linewidth}}
	...
	{\ttfamily\bfseries BLOAD "MYFILE.BIN",8,1,\$A000}&Loads a file named "MYFILE.BIN from device 8 starting in bank 1 at \$A000".\\\\

	{\ttfamily\bfseries BLOAD "WHO.PCX",8,10,\$B000}&Loads a file named "WHO.PCX from device 8 starting in bank 10 at \$B000".\\\\
