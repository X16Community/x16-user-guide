...
\begin{tabular}{l p{0.8\linewidth}}
	...
	Type \keybackgroundcolor{white}\key{1} \key{0} \widekey{space} \key{p}
	\key{r} \key{i} \key{n} \key{t} \key{"} \widekey{space} \key{x} \key{1}
	\key{6} \key{"} \key{;} and press
	\keybackgroundcolor{gray}\widekey{return}.\\

	\bfseries STEP 4:&

	Type \keybackgroundcolor{white}\key{2} \key{0} \widekey{space} \key{g}
	\key{o} \key{t} \key{o} \widekey{space} \key{1} \key{0} and press
	\keybackgroundcolor{gray}\widekey{return}.
