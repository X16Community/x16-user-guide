...
\include{appendix/screen_codes_table}

\include{appendix/petscii_codes_table}

\include{appendix/memory_map}

\include{appendix/65c02_op_codes}

\include{appendix/patch_table}

\include{appendix/music_play_macros}

\include{appendix/ym2151}
